...
train_gt = np.load('../train_dump_groundtruth.npy')
train_image = np.load("../train_dump_img.npy")
validate_gt = np.load("../val_dump_groundtruth.npy")
validate_image = np.load("../val_dump_img.npy")
